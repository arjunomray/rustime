...
fn countdown(min: i32, session_type: SessionType, session_title: &String, session_counter: i32) {
    let mut sec = min * 60;
...
pub fn pomodoro(session_time: i32, break_time: i32, session_name: &String) {
    ...
    loop {
        loop {
            ...
            match session_check.as_str() {
                "y" | "yes" => {
                    countdown(session_time, SessionType::SESSION, session_name, session_counter);
                    session_counter += 1;
                    break;
                }
        ...
        loop {
            ...
            match break_check.as_str() {
                "y" | "yes" => {
                    countdown(break_time, SessionType::BREAK, session_name, session_counter);
                    break;
                }
...
fn render_art(session_type: &SessionType) {
    match session_type {
        SessionType::SESSION => {
            println!(
                r#"
